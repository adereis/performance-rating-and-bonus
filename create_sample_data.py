...
def get_small_team_data():
    ...
    employees = [
        ...
        ('Addie Min', 'Senior Software Developer', 152000, 'USD', 'IC3', 12, 110, 'Solid access management and security work'),
        ('Tim Out', 'Software Developer', 110000, 'USD', 'IC2', 10, 85, 'Needs improvement in reliability and uptime'),
        ('Barbie Que', 'Senior SRE', 149000, 'USD', 'IC3', 12, 110, 'Strong message queue management'),
    ]
...
def get_large_org_data():
    ...
    team_configs = {
        'Supervisory Organization (Della Gate)': [
            ...
            ('Senior Software Developer', 152000, 'IC3', 12, 110, 'Solid mentorship and code quality'),
        ],
        'Supervisory Organization (Rhoda Map)': [
            ('Staff Software Developer', 175000, 'IC4', 15, 185, 'Exceptional performance - transformational UI architecture work'),
            ('Engineering Manager', 185000, 'M3', 18, 130, 'Strong team growth and technical direction'),
            ('Senior Software Developer', 155000, 'IC3', 12, 120, 'Strong React component library work'),
            ('Senior Software Developer', 149000, 'IC3', 12, 110, 'Solid accessibility improvements'),
            ('Software Developer', 110000, 'IC2', 10, 45, 'Serious performance concerns - requires improvement plan'),
            ('Software Developer', 125000, 'IC2', 10, 100, 'Good responsive design work'),
            ('Senior Software Developer', 147000, 'IC3', 12, 115, 'Excellent state management refactoring'),
            ('Software Developer', 122000, 'IC2', 10, 100, 'Solid component development'),
            ('Software Developer', 119000, 'IC2', 10, 65, 'Below expectations - needs significant improvement'),
            ('Software Developer', 116000, 'IC2', 10, 85, 'Needs more proactive communication'),
        ],
        'Supervisory Organization (Kay P. Eye)': [
            ('Principal Software Developer', 215000, 'IC5', 20, 140, 'Exceptional distributed systems architecture'),
            ('Staff Software Developer', 182000, 'IC4', 15, 130, 'Outstanding microservices design'),
            ('Engineering Manager', 188000, 'M3', 18, 130, 'Excellent cross-team coordination and delivery'),
            ('Senior Software Developer', 158000, 'IC3', 12, 120, 'Strong API design and implementation'),
            ('Senior Software Developer', 152000, 'IC3', 12, 110, 'Solid service reliability work'),
            ...
            ('Software Developer', 125000, 'IC2', 10, 90, 'Adequate progress on microservices'),
        ],
        'Supervisory Organization (Agie Enda)': [
            ...
            ('Senior SRE', 152000, 'IC3', 12, 110, 'Strong Kubernetes migration work'),
            ('SRE', 125000, 'IC2', 10, 105, 'Good infrastructure automation'),
            ('SRE', 122000, 'IC2', 10, 100, 'Solid monitoring setup'),
        ...
        'Supervisory Organization (Mai Stone)': [
            ('Staff SRE', 188000, 'IC4', 15, 135, 'Outstanding SLO/SLI framework design'),
            ('Engineering Manager', 195000, 'M3', 18, 130, 'Excellent reliability culture building'),
            ('Senior SRE', 160000, 'IC3', 12, 125, 'Exceptional on-call process improvements'),
            ('Senior SRE', 156000, 'IC3', 12, 120, 'Strong incident response leadership'),
            ('Senior SRE', 153000, 'IC3', 12, 110, 'Solid observability improvements'),
            ('SRE', 128000, 'IC2', 10, 110, 'Strong monitoring and alerting work'),
            ('SRE', 124000, 'IC2', 10, 100, 'Good chaos engineering initiatives'),
            ('SRE', 120000, 'IC2', 10, 100, 'Solid capacity planning work'),
            ('SRE', 118000, 'IC2', 10, 95, 'Adequate progress on reliability metrics'),
