...
- **Documentation**: Authored README.md, docs/BONUS_CALCULATION_README.md, and inline code documentation
...
- **Never change bonus algorithm** without updating docs/BONUS_CALCULATION_README.md
...
2. Update `docs/BONUS_CALCULATION_README.md` with manager-friendly explanation
...
- **Configuration**: Tenets defined in `samples/tenets-sample.json` (version controlled)
...
- Files generated by `scripts/create_sample_data.py`
...
#### `scripts/populate_sample_ratings.py` (Legacy)
- Older script for adding ratings to existing data
- Consider deprecating in favor of scripts/create_sample_data.py

#### `samples/` (Sample Data Files)
- `tenets-sample.json` - Example tenets configuration (version controlled)
- `sample-historical-*.xlsx` - Generated historical data for testing
